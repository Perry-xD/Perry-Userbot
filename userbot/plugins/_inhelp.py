...
if Config.BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        result = None
        query = event.text
        if event.query.user_id == bot.uid and query == "PerryBot_help":
            rev_text = query[::-1]
            ...
            result = builder.article(
                ...
                buttons=[
                    ...
                    [Button.url("🚀 Deploy 🚀", "https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FThe-HellBot%2FHellBot&template=https%3A%2F%2Fgithub.com%2Fthe-PerryBot%2FPerryBot")],
                ],
            )
            ...
            result = builder.article(
                "@Its_HellBot",
                text="""**Hey! This is [Hêllẞø†](https://t.me/its_PerryBot) \nYou can know more about me from the links given below 👇**""",
                buttons=[
                    [
                        custom.Button.url("🔥 CHANNEL 🔥", "https://t.me/Its_HellBot"),
                        custom.Button.url(
                            "⚡ GROUP ⚡", "https://t.me/PerryBot_chat"
                        ),
                    ],
                    [
                        custom.Button.url(
